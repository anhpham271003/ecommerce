    ...
    <>
      ...
      <div className="productContent !w-[60%] !mt-5 !ml-5">
        ...
        <p className="line-clamp-5 text-[rgba(0,0,0,0.7)] font-liber !text-[18px]">
          ...
          vero exercitationem illo saepe aspernatur mollitia laudantium
          quibusdam quasi ratione vel unde excepturi corporis voluptatem ex in
          eligendi, labore a voluptatum autem. Dolore natus nostrum accusamus
          voluptatum eligendi provident, enim placeat cumque labore? Minus
          repellat, assumenda distinctio illum a omnis.
        </p>
        ...
        <div className="flex items-center ">
          ...
          <Button className="!bg-primary !text-white !rounded-full hover:!bg-red-500 transition !capitalize !px-10 !mx-5">
            <MdOutlineShoppingCart className="text-[22px] !mr-2" /> Add to Cart
          </Button>
        </div>
