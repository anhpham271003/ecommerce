...
const ProductItemListView = () => {
  return (
    <div className="productItem h-fit overflow-hidden rounded-lg shadow-md flex items-center !m-0 bg-[#f1f1f1]">
      <div className="imgWrapper w-[25%]  overflow-hidden relative group">
        <Link to="/">
          <div className= "img h-[220px] overflow-hidden">
            ...
            class="h-[220px] w-full  !object-contain object-center transition-all duration-800 group-hover:opacity-0"
            alt=""
          />
            <img
            src="https://pisces.bbystatic.com/image2/BestBuy_US/images/products/6487/6487267_sd.jpg"
            class="h-[220px] w-full !object-contain object-center transition-all duration-800 absolute top-0 left-0 opacity-0 group-hover:opacity-100"
            alt=""
          />
          </div>
        </Link>
      ...
      <div className="info p-2 text-left bg-[#f1f1f1] w-[75%]">
        ...
        <h3 className="text-[15px] font-nata leading-[18px] !mt-2 mb-1 font-[500]">
          <Link to="/" className="transition-all hover:text-[#ff5252] line-clamp-3">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sed,dsvvvvvvvvvdvsvedfvdvsdvsdvsdv
            omnis? lorem50
          </Link>
        </h3>
        <Rating name="size-small" defaultValue={2} size="small" readOnly />
        <div className="flex items-center gap-4 pb-3">
          <span className="line-through text-gray-500 text-[15px] font-[500] !m-0">
            $60.00
          </span>
